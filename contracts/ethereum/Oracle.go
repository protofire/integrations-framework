...
import (
	...
	"github.com/ethereum/go-ethereumounts/abi"
	"github.com/ethereum/go-ethereumounts/abi/bind"
	"github.com/ethereum/go-ethereummon"
	"github.com/ethereum/go-ethereume/types"
	"github.com/ethereum/go-ethereumnt"
)
...
// CanethereumracleRequest is a paid mutator transaction binding the contract method 0x6ee4d553.
//
// Solidity: function canethereumracleRequest(bytes32 _requestId, uint256 _payment, bytes4 _callbackFunc, uint256 _expiration) returns()
func (_Oracle *OracleTransactor) CanethereumracleRequest(opts *bind.TransactOpts, _requestId [32]byte, _payment *big.Int, _callbackFunc [4]byte, _expiration *big.Int) (*types.Transaction, error) {
	return _Oracle.contract.Transact(opts, "canethereumracleRequest", _requestId, _payment, _callbackFunc, _expiration)
}

// CanethereumracleRequest is a paid mutator transaction binding the contract method 0x6ee4d553.
//
// Solidity: function canethereumracleRequest(bytes32 _requestId, uint256 _payment, bytes4 _callbackFunc, uint256 _expiration) returns()
func (_Oracle *OracleSession) CanethereumracleRequest(_requestId [32]byte, _payment *big.Int, _callbackFunc [4]byte, _expiration *big.Int) (*types.Transaction, error) {
	return _Oracle.Contract.CanethereumracleRequest(&_Oracle.TransactOpts, _requestId, _payment, _callbackFunc, _expiration)
}

// CanethereumracleRequest is a paid mutator transaction binding the contract method 0x6ee4d553.
//
// Solidity: function canethereumracleRequest(bytes32 _requestId, uint256 _payment, bytes4 _callbackFunc, uint256 _expiration) returns()
func (_Oracle *OracleTransactorSession) CanethereumracleRequest(_requestId [32]byte, _payment *big.Int, _callbackFunc [4]byte, _expiration *big.Int) (*types.Transaction, error) {
	return _Oracle.Contract.CanethereumracleRequest(&_Oracle.TransactOpts, _requestId, _payment, _callbackFunc, _expiration)
}
...
// OracleCanethereumracleRequestIterator is returned from FilterCanethereumracleRequest and is used to iterate over the raw logs and unpacked data for CanethereumracleRequest events raised by the Oracle contract.
type OracleCanethereumracleRequestIterator struct {
	Event *OracleCanethereumracleRequest // Event containing the contract specifics and raw log
...
func (it *OracleCanethereumracleRequestIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(OracleCanethereumracleRequest)
...
func (it *OracleCanethereumracleRequestIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *OracleCanethereumracleRequestIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// OracleCanethereumracleRequest represents a CanethereumracleRequest event raised by the Oracle contract.
type OracleCanethereumracleRequest struct {
	RequestId [32]byte
	Raw       types.Log // Blockchain specific contextual infos
}

// FilterCanethereumracleRequest is a free log retrieval operation binding the contract event 0xa7842b9ec549398102c0d91b1b9919b2f20558aefdadf57528a95c6cd3292e93.
//
// Solidity: event CanethereumracleRequest(bytes32 indexed requestId)
func (_Oracle *OracleFilterer) FilterCanethereumracleRequest(opts *bind.FilterOpts, requestId [][32]byte) (*OracleCanethereumracleRequestIterator, error) {
	...
	logs, sub, err := _Oracle.contract.FilterLogs(opts, "CanethereumracleRequest", requestIdRule)
	if err != nil {
		return nil, err
	}
	return &OracleCanethereumracleRequestIterator{contract: _Oracle.contract, event: "CanethereumracleRequest", logs: logs, sub: sub}, nil
}

// WatchCanethereumracleRequest is a free log subscription operation binding the contract event 0xa7842b9ec549398102c0d91b1b9919b2f20558aefdadf57528a95c6cd3292e93.
//
// Solidity: event CanethereumracleRequest(bytes32 indexed requestId)
func (_Oracle *OracleFilterer) WatchCanethereumracleRequest(opts *bind.WatchOpts, sink chan<- *OracleCanethereumracleRequest, requestId [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _Oracle.contract.WatchLogs(opts, "CanethereumracleRequest", requestIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(OracleCanethereumracleRequest)
				if err := _Oracle.contract.UnpackLog(event, "CanethereumracleRequest", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseCanethereumracleRequest is a log parse operation binding the contract event 0xa7842b9ec549398102c0d91b1b9919b2f20558aefdadf57528a95c6cd3292e93.
//
// Solidity: event CanethereumracleRequest(bytes32 indexed requestId)
func (_Oracle *OracleFilterer) ParseCanethereumracleRequest(log types.Log) (*OracleCanethereumracleRequest, error) {
	event := new(OracleCanethereumracleRequest)
	if err := _Oracle.contract.UnpackLog(event, "CanethereumracleRequest", log); err != nil {
		return nil, err
	}
