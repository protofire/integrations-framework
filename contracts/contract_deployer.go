...
import (
	...
	"github.com/smartcontractkit/integrations-framework/contracts/klaytn"
...
func NewContractDeployer(bcClient client.BlockchainClient) (ContractDeployer, error) {
	...
	case *client.KlaytnClient:
		return NewEthereumContractDeployer(clientImpl), nil
	case *client.KlaytnClients:
...
func NewEthereumContractDeployer(ethClient *client.KlaytnClient) *EthereumContractDeployer {
...
func (e *EthereumContractDeployer) DeployReadAccessController(
	...
	address, _, instance, err := e.eth.DeployContract(
		...
		func(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, interface{}, error) {
			return klaytn.DeploySimpleReadAccessController(auth, backend)
		})
	if err != nil {
		return nil, err
	}
	return &EthereumReadAccessController{
		client:       e.eth,
		rac:          instance.(*klaytn.SimpleReadAccessController),
...
func (e *EthereumContractDeployer) DeployFlags(
	...
	address, _, instance, err := e.eth.DeployContract(
		...
		func(
			...
			return klaytn.DeployFlags(auth, backend, racAddr)
		})
	if err != nil {
		return nil, err
	}
...
func (e *EthereumContractDeployer) DeployDeviationFlaggingValidator(
	...
	address, _, instance, err := e.eth.DeployContract(
		...
		func(
			...
			return klaytn.DeployDeviationFlaggingValidator(auth, backend, flagAddr, flaggingThreshold)
		})
	if err != nil {
		return nil, err
	}
	return &EthereumDeviationFlaggingValidator{
		client:       e.eth,
		dfv:          instance.(*klaytn.DeviationFlaggingValidator),
		callerWallet: fromWallet,
		address:      address,
	}, nil
}
...
func (e *EthereumContractDeployer) DeployFluxAggregatorContract(
	...
	address, _, instance, err := e.eth.DeployContract(
		...
		func(
			...
			return klaytn.DeployFluxAggregator(auth,
				backend,
				linkAddress,
	...
	return &EthereumFluxAggregator{
		client:         e.eth,
		fluxAggregator: instance.(*klaytn.FluxAggregator),
		callerWallet:   fromWallet,
		address:        address,
	}, nil
}
...
func (e *EthereumContractDeployer) DeployLinkTokenContract(fromWallet client.BlockchainWallet) (LinkToken, error) {
	linkTokenAddress, _, instance, err := e.eth.DeployContract(
		...
		func(
			...
			return klaytn.DeployLinkToken(auth, backend)
		})
	if err != nil {
		return nil, err
	}
	...
	return &EthereumLinkToken{
		client:       e.eth,
		linkToken:    instance.(*klaytn.LinkToken),
		callerWallet: fromWallet,
...
func (e *EthereumContractDeployer) DeployOffChainAggregator(
	...
	address, _, instance, err := e.eth.DeployContract(
		...
		func(
			...
			linkAddress := common.HexToAddress(e.eth.Network.Config().LinkTokenAddress)
			return klaytn.DeployOffchainAggregator(auth,
				backend,
	...
	return &EthereumOffchainAggregator{
		client:       e.eth,
		ocr:          instance.(*klaytn.OffchainAggregator),
		callerWallet: fromWallet,
		address:      address,
	}, err
}
...
func (e *EthereumContractDeployer) DeployStorageContract(fromWallet client.BlockchainWallet) (Storage, error) {
	_, _, instance, err := e.eth.DeployContract(fromWallet, "Storage", func(
		...
		return klaytn.DeployStore(auth, backend)
	})
	if err != nil {
		return nil, err
	}
...
func (e *EthereumContractDeployer) DeployAPIConsumer(fromWallet client.BlockchainWallet, linkAddr string) (APIConsumer, error) {
	addr, _, instance, err := e.eth.DeployContract(fromWallet, "APIConsumer", func(
		...
		return klaytn.DeployAPIConsumer(auth, backend, common.HexToAddress(linkAddr))
	})
	if err != nil {
		return nil, err
	}
	return &EthereumAPIConsumer{
		address:      addr,
		client:       e.eth,
		consumer:     instance.(*klaytn.APIConsumer),
		callerWallet: fromWallet,
	}, err
}
...
func (e *EthereumContractDeployer) DeployOracle(fromWallet client.BlockchainWallet, linkAddr string) (Oracle, error) {
	addr, _, instance, err := e.eth.DeployContract(fromWallet, "Oracle", func(
		...
		return klaytn.DeployOracle(auth, backend, common.HexToAddress(linkAddr))
	})
	if err != nil {
		return nil, err
	}
...
func (e *EthereumContractDeployer) DeployVRFContract(fromWallet client.BlockchainWallet) (VRF, error) {
	address, _, instance, err := e.eth.DeployContract(fromWallet, "VRF", func(
		...
		return klaytn.DeployVRF(auth, backend)
	})
	if err != nil {
		return nil, err
	}
...
func (e *EthereumContractDeployer) DeployMockETHLINKFeed(fromWallet client.BlockchainWallet, answer *big.Int) (MockETHLINKFeed, error) {
	address, _, instance, err := e.eth.DeployContract(
		...
		func(
			...
			return klaytn.DeployMockETHLINKAggregator(auth, backend, answer)
		})
	if err != nil {
		return nil, err
	}
	return &EthereumMockETHLINKFeed{
		client:       e.eth,
		feed:         instance.(*klaytn.MockETHLINKAggregator),
		callerWallet: fromWallet,
		address:      address,
	}, err
}
...
func (e *EthereumContractDeployer) DeployMockGasFeed(fromWallet client.BlockchainWallet, answer *big.Int) (MockGasFeed, error) {
	address, _, instance, err := e.eth.DeployContract(
		...
		func(
			...
			return klaytn.DeployMockGASAggregator(auth, backend, answer)
		})
	if err != nil {
		return nil, err
	}
	return &EthereumMockGASFeed{
		client:       e.eth,
		feed:         instance.(*klaytn.MockGASAggregator),
		callerWallet: fromWallet,
		address:      address,
	}, err
}
...
func (e *EthereumContractDeployer) DeployUpkeepRegistrationRequests(fromWallet client.BlockchainWallet, linkAddr string, minLinkJuels *big.Int) (UpkeepRegistrar, error) {
	address, _, instance, err := e.eth.DeployContract(
		...
		func(
			...
			return klaytn.DeployUpkeepRegistrationRequests(auth, backend, common.HexToAddress(linkAddr), minLinkJuels)
		})
	if err != nil {
		return nil, err
	}
	return &EthereumUpkeepRegistrationRequests{
		client:       e.eth,
		registrar:    instance.(*klaytn.UpkeepRegistrationRequests),
		callerWallet: fromWallet,
		address:      address,
	}, err
}
...
func (e *EthereumContractDeployer) DeployKeeperRegistry(
	...
	address, _, instance, err := e.eth.DeployContract(
		...
		func(
			...
			return klaytn.DeployKeeperRegistry(
				auth,
				backend,
	...
	return &EthereumKeeperRegistry{
		client:       e.eth,
		registry:     instance.(*klaytn.KeeperRegistry),
		callerWallet: fromWallet,
		address:      address,
	}, err
}
...
func (e *EthereumContractDeployer) DeployKeeperConsumer(fromWallet client.BlockchainWallet, updateInterval *big.Int) (KeeperConsumer, error) {
	address, _, instance, err := e.eth.DeployContract(
		...
		func(
			...
			return klaytn.DeployKeeperConsumer(auth, backend, updateInterval)
		})
	if err != nil {
		return nil, err
	}
	return &EthereumKeeperConsumer{
		client:       e.eth,
		consumer:     instance.(*klaytn.KeeperConsumer),
		callerWallet: fromWallet,
		address:      address,
	}, err
}
...
func (e *EthereumContractDeployer) DeployBlockhashStore(fromWallet client.BlockchainWallet) (BlockHashStore, error) {
	address, _, instance, err := e.eth.DeployContract(
		...
		func(
			...
			return klaytn.DeployBlockhashStore(auth, backend)
		})
	if err != nil {
		return nil, err
	}
	return &EthereumBlockhashStore{
		client:         e.eth,
		blockHashStore: instance.(*klaytn.BlockhashStore),
		callerWallet:   fromWallet,
		address:        address,
	}, err
}
...
func (e *EthereumContractDeployer) DeployVRFCoordinator(fromWallet client.BlockchainWallet, linkAddr string, bhsAddr string) (VRFCoordinator, error) {
	address, _, instance, err := e.eth.DeployContract(
		...
		func(
			...
			return klaytn.DeployVRFCoordinator(auth, backend, common.HexToAddress(linkAddr), common.HexToAddress(bhsAddr))
		})
	if err != nil {
		return nil, err
	}
	return &EthereumVRFCoordinator{
		client:       e.eth,
		coordinator:  instance.(*klaytn.VRFCoordinator),
		callerWallet: fromWallet,
		address:      address,
	}, err
}
...
func (e *EthereumContractDeployer) DeployVRFConsumer(fromWallet client.BlockchainWallet, linkAddr string, coordinatorAddr string) (VRFConsumer, error) {
	address, _, instance, err := e.eth.DeployContract(
		...
		func(
			...
			return klaytn.DeployVRFConsumer(auth, backend, common.HexToAddress(coordinatorAddr), common.HexToAddress(linkAddr))
		})
	if err != nil {
		return nil, err
	}
	return &EthereumVRFConsumer{
		client:       e.eth,
		consumer:     instance.(*klaytn.VRFConsumer),
		callerWallet: fromWallet,
		address:      address,
	}, err
}
